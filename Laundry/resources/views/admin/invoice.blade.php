    ...
    <div class="card w-50 m-auto mt-4 mb-4">
        <div class="card-body mx-4">
            ...
            <div class="mt-3">
                ...
                <div class="blockquote-footer text-center">Hasil kebersihan laundry bergantung pada keimanan Anda, karena kebersihan adalah sebagian dari iman.</div>
            </div>
            <div class="row">
                ...
                <div class="col-xl-2">
                    <p class="float-end">{{$dataOrder->berat}} Kg</p>
                </div>
                <hr>
            </div>
