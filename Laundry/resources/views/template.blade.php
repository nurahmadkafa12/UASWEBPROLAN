...
<header class="d-flex flex-wrap justify-content-center py-3 px-5 mb-4 shadow-sm bg-white">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
      ...
      <span class="px-3 fs-4" style="font-weight: bolder; color: #1a375f">Diva Laundry</span>
    </a>
    ...
    <ul class="nav nav-pills">
      ...
      <li class="nav-item mt-3 px-3"><a href="{{ url('/about') }}" style=" text-decoration: none; color: #1a375f;">Contact Person</a></li>
      @guest
        @if (Route::has('login'))
